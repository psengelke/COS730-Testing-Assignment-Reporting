...
\subsubsection{By Some Combination }
A report filtered by both Entity and PublicationType should be returned, this is not possible since no functionality was implemented with the required filters.
